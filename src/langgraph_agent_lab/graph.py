...
def build_graph(
    ...
    The graph keeps node boundaries explicit: classification chooses a route, routing functions
    select the next node, and evaluation provides the retry loop's done check.
    """
    try:
